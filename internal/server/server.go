...
func (s *Server) mountHandlers() {
	...
	mux.Handle("POST /recipes/{id}/highlight", s.mustBeLoggedInMiddleware(s.recipeHighlightHandler()))
	mux.Handle("POST /recipes/{id}/nutrition/refresh", s.mustBeLoggedInMiddleware(s.recipesRefreshNutritionHandler()))
	...
	mux.Handle("DELETE /recipes/categories", withLog(s.recipesCategoriesDeleteHandler()))
	mux.Handle("POST /recipes/categories", withLog(s.recipesCategoriesPostHandler()))
	...
	mux.Handle("POST /settings/recipes/bulk-language", withLog(s.settingsRecipesBulkLanguagePostHandler()))
	mux.Handle("POST /settings/recipe-language", withLog(s.settingsRecipeLanguagePostHandler()))
